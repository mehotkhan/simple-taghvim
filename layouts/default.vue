  ...
  <div>
    <div class="flex h-screen overflow-hidden bg-white">
      ...
      >
        ...
        >
          <span
            class="p-2 text-3xl font-semibold leading-8 tracking-wider uppercase whitespace-nowrap"
          >
            گـــ<span :class="{ 'lg:hidden': !isSidebarOpen }"
              >ـاه‌نـــامه</span
            >
          </span>
          ...
          <ul class="p-2 overflow-hidden">
            <li>
              ...
              >
                ...
                <span :class="{ 'lg:hidden': !isSidebarOpen }">ابزارها</span>
              </a>
            </li>
            <!-- Sidebar Links... -->
          </ul>
            ...
            <div class="flex items-center space-x-3">
              ...
              >
                <div class="flex items-center">
                  <!-- search icon -->
                  امروز چند شنبه چندم چندمین است :)
                </div>
              </div>
            </div>

            <!-- Navbar right -->
            <div class="relative flex items-center gap-5 ml-2">
              <NotificationButton />
              <SettingsButton />
              <AvatarButton />
            </div>
